# Getting Started: Account Aggregator Connector Project

This is a starting point account aggregator connector - to gain access to accounts and transactions that are external to your core.
